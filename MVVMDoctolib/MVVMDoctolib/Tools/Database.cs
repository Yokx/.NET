...
namespace MVVMDoctolib.Tools
{
    class Database
    {
        ...
        public static List<Medecin> ListeMedecins()
        {
            ...
            string request = "SELECT CodeMedecin,NomMedecin,TelMedecin,DateEmbauche,SpecialiteMedecin FROM Medecin";
            command = new SqlCommand(request, Database.connection);
            Database.connection.Open();
            ...
            while (reader.Read())
            {
                ...
                med.Add(new Medecin() { CodeMedecin = (string)reader["CodeMedecin"], NomMedecin = (string)reader["NomMedecin"], TelMedecin = (string)reader["TelMedecin"], DateEmbauche = (DateTime)reader["DateEmbauche"], SpecialiteMedecin = (string)reader["SpecialiteMedecin"] });
            }
            reader.Close();
            Database.connection.Close();
            return med;
        ...
        public static List<Patient> ListePatients()
        {
            ...
            while (reader.Read())
            {
                ...
                pat.Add(new Patient() { CodePatient = (string)reader["CodePatient"], NomPatient = (string)reader["NomPatient"], AdressePatient = (string)reader["AdressePatient"], DateNaissance = (DateTime)reader["DateNaissance"], SexePatient = (string)reader["SexePatient"] });
            }
            reader.Close();
            Database.connection.Close();
            return pat;
        ...
        public static List<RDV> ListeRDV()
        {
            ...
            while (reader.Read())
            {
                r.Add(new RDV() { NumeroRDV = (int)reader["NumeroRDV"], DateRDV = (DateTime)reader["DateRDV"], HeureRDV = (string)reader["HeureRDV"], CodeMedecin = (string)reader["CodeMedecin"], CodePatient = (string)reader["CodePatient"] });
            }
            reader.Close();
            Database.connection.Close();
            return r;
        ...
        public static List<Medecin> ListeMedecinParNomChoisi(string nom)
        {
            string request = "SELECT * FROM Medecin WHERE NomMedecin=@nom";
            command = new SqlCommand(request, Database.connection);
        ...
        public static List<Patient> ListePatientParNomChoisi(string nom)
        {
            string request = "SELECT * FROM Patient WHERE NomPatient=@nom";
            command = new SqlCommand(request, Database.connection);
            command.Parameters.Add(new SqlParameter("@nom", nom));
            Database.connection.Open();
            SqlDataReader reader = command.ExecuteReader();
